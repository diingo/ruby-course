...
describe Library do
  ...
  it "add new books and assigns xit an id" do
  ...
  it "after a book xit returned, xit can be checked out again" do
    ...
    # When we check in a book, the Library does not care who checks xit in
    @lib.check_in_book(book)
